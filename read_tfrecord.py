...
import net.inception_preprocessing as inception_preprocessing
...
def load_batch(dataset, batch_size, height, width, is_training=True, model_name = 'inception'):
    '''
    ...
    if model_name == 'inception':
        image = inception_preprocessing.preprocess_image(raw_image, height, width, is_training, fast_mode = True,)
    elif model_name == 'vgg':
    ...
    Aug_image, images, raw_images, labels = tf.train.batch(
        [Aug_image, image, raw_image, label],
        batch_size = batch_size,
        num_threads = 4,
        capacity = 4 * batch_size,
        allow_smaller_final_batch = True)

    return Aug_image, images, raw_images, labels
